...
prior_dir = "./gp_reward-priors/exp/reward_learning/antmaze_tuning/br-antmaze_medium_diverse-64-4/ckpts/it-1000.ckpt"
...
saved_dir = os.path.join(
    "./antmaze_models/antmaze_br/optim/antmaze-medium-diverse-v2/reduce_90_br",
    "sampling_optim",
)
