...
X_train, y_train, _, _ = util.load_pref_data(
    "./gp_reward-priors/data/antmaze/antmaze-large-play-v2_pref.hdf5", 0.1
)

prior_dir = "./gp_reward-priors/exp/reward_learning/antmaze_tuning/br-antmaze_large_play-64-4/ckpts/it-1000.ckpt"
...
saved_dir = os.path.join(
    "./antmaze_models/antmaze_br/optim/antmaze-large-play-v2/reduce_90_br",
    "sampling_optim",
)
