...
prior_dir = "./gp_reward-priors/exp/reward_learning/antmaze_tuning/br-antmaze_medium_play-256-3/ckpts/it-1000.ckpt"
...
saved_dir = os.path.join(
    "./antmaze_models/antmaze_br/optim/antmaze-medium-play-v2/reduce_70_br",
    "sampling_optim",
)
